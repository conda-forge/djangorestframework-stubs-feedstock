...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/djangorestframework-stubs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12730&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/djangorestframework-stubs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `djangorestframework-stubs` can be installed with:

```
conda install djangorestframework-stubs
```

It is possible to list all of the versions of `djangorestframework-stubs` available on your platform with:
